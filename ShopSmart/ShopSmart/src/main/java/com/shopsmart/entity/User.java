...
public class User implements UserDetails {
    ...
    private boolean is2faEnabled = false; // Default to false

    @Column(name = "two_factor_code")
    private String twoFactorCode; // Stores the temporary 2FA code

    @Column(name = "two_factor_code_expiry")
    private LocalDateTime twoFactorCodeExpiry; // Stores the expiration time of the 2FA code
    ...
    // Updated constructor to include 2FA fields
    ...
    // NEW: Getters and Setters for 2FA fields
    ...
    public String toString() {
        return "User [id=" + id + ", username=" + username + ", email=" + email + ", phoneNumber=" + phoneNumber
                + ", active=" + active + ", is2faEnabled=" + is2faEnabled +
